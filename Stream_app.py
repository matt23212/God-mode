...
<style>
    ...
    div[data-testid="stMetricLabel"] { color: #888; font-size: 12px; font-weight: 600; }
    div[data-testid="stMetricValue"] { color: #fff; font-size: 20px; font-family: 'Roboto Mono', monospace; }
    div[data-testid="stMetricDelta"] { color: #00C805; font-size: 12px; }
    ...
    /* BADGE STYLES */
    .confidence-high { color: #00C805; font-weight: 800; }
    .confidence-med { color: #F59E0B; font-weight: 800; }
